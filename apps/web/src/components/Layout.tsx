...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden px-4 py-4 md:px-6">
      ...
      <header className="panel sticky top-4 z-40 mx-auto mb-8 flex w-full max-w-7xl flex-wrap items-center justify-between gap-4 rounded-[2rem] px-5 py-4">
        <Link className="flex items-center gap-4" to="/">
          <div className="glow-ring rounded-[1.25rem] bg-[var(--text)] px-4 py-3 text-sm font-semibold tracking-[0.24em] text-white">
            CIP
          </div>
          <div>
